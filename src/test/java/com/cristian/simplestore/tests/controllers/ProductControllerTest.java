...
public class ProductControllerTest extends BaseTest {
	...
	public void testItFindsAllProducts() throws JsonParseException, JsonMappingException, IOException {
		...
		List<Product> responseProducts = sendFindAllProductsRequest();
				
		assertThat(responseProducts.size()).isEqualTo(MAX_PRODUCTS_SIZE);		
	}
	...
	public void testItFindsAProductById() throws JsonParseException, JsonMappingException, IOException {
	    ...
	    Product foundProduct = sendFindProductByIdRequest(product.getId());
	...
	public void testItCreatesAProduct() throws JsonParseException, JsonMappingException, IOException {
		...
		Product createdProduct = sendProductCreateRequest(product);
	...
	public void testItUpdatesAProduct() throws JsonParseException, JsonMappingException, IOException {
		...
		Product updatedProduct = sendProductUpdateRequest(newProductData);
	...
	public void testItDeletesAProduct() throws JsonParseException, JsonMappingException, IOException {
		...
		sendProductDeleteRequest(product);
		
		productRepository.findById(product.getId()).get();
	}
	
	public List<Product> sendFindAllProductsRequest() throws JsonParseException, JsonMappingException, IOException {
	...
	public Product sendFindProductByIdRequest(Long id) throws JsonParseException, JsonMappingException, IOException {
	...
	public Product sendProductCreateRequest(Product product) throws JsonParseException, JsonMappingException, IOException {	
		String url = "/api/admin/products";
		...
		Product createdProduct = (Product) getContentFromJsonRespose(jsonResponse.getBody(), Product.class);
		
		return createdProduct;
	}
	
	public Product sendProductUpdateRequest(Product product) throws JsonParseException, JsonMappingException, IOException {	
	...
	public void sendProductDeleteRequest(Product product) throws JsonParseException, JsonMappingException, IOException {	
		String url = "/api/admin/products/" + product.getId();
