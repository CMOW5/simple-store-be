package com.cristian.simplestore.infrastructure.storage;
...
import com.cristian.simplestore.infrastructure.storage.exception.StorageException;
...
public class ImageStorageService implements StorageService {
	...
	/**
	 * this method store a image in the storage folder with the given filename, the
	 * method returns the full path of the image stored
	 * 
