...
import com.cristian.simplestore.infrastructure.security.CustomUserDetailsService;
import com.cristian.simplestore.infrastructure.security.RestAuthenticationEntryPoint;
import com.cristian.simplestore.infrastructure.security.TokenAuthenticationFilter;
import com.cristian.simplestore.infrastructure.security.oauth2.CustomOAuth2UserService;
import com.cristian.simplestore.infrastructure.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.cristian.simplestore.infrastructure.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.cristian.simplestore.infrastructure.security.oauth2.OAuth2AuthenticationSuccessHandler;
        ...
        http
          ...
          .authorizeRequests()
              .antMatchers("/",
                  ...
                  "/**/*.js")
                  .permitAll()
              .antMatchers("/api/auth/**", "/oauth2/**", "/api/images/**", "/api/**")
                  .permitAll()
              .anyRequest()
                  .authenticated()
              .and()
