...
import static com.cristian.simplestore.infrastructure.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
 ...
 * the user and sends the user to the redirect_uri along with the JWT token in a query string.
 * 
 * @author bit5
 *
 */
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
  ...
  /**
   * Spring security invokes this method of the OAuth2AuthenticationSuccessHandler configured in
   * SecurityConfig.
   * 
   * In this method, we perform some validations, create a JWT authentication token, and redirect
   * the user to the redirect_uri specified by the client with the JWT token added in the query
   * string
   */
  @Override
