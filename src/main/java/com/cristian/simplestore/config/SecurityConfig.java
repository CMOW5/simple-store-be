...
import com.cristian.simplestore.security.CustomUserDetailsService;
import com.cristian.simplestore.security.RestAuthenticationEntryPoint;
import com.cristian.simplestore.security.TokenAuthenticationFilter;
import com.cristian.simplestore.security.oauth2.CustomOAuth2UserService;
import com.cristian.simplestore.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
        ...
        http
          ...
          .authorizeRequests()
              .antMatchers("/",
                  ...
                  "/**/*.js")
                  .permitAll()
              .antMatchers("/api/auth/**", "/oauth2/**", "/api/images/**", "/api/test/**")
                  .permitAll()
              .anyRequest()
                  .authenticated()
              .and()
